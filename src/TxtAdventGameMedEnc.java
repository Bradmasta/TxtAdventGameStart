...
public class TxtAdventGameMedEnc {
	...
	public void randMediumStart(int room, String roomName[], int[][] whereToGo, String[] directions, int[] myStats, int[] invo, int[] flags) {
		 int enemyStats[] = {25, 8, 6, newRand.randMedEnemySpd()};
		 randEncounterMedium(room, roomName, whereToGo, directions, myStats, enemyStats, invo, flags);
		  
	  }

	  public void randEncounterMedium(int room, String roomName[], int[][] whereToGo, String[] directions, int[] myStats, int[] enemyStats, int[] invo, int[] flags) {
